  ...
  <q-page >
    <div class="rounded-box q-mb-lg">
      <div class="page-search">
        <q-btn @click="$router.back()" class="btn-bg" icon="chevron_left" label="Назад" unelevated no-caps/>
        <p class="no-margin title text-bold">{{user.fio}} </p>
        <q-space/>

        <q-btn  class="btn-bg" label="Логин и пароль" unelevated no-caps/>
    ...
    <div class="rounded-box">
      <div class="flex items-center">
        ...
        <div class="">
          <p class="text-body2 flex q-mb-sm">
          ...
          <p class="no-margin text-body2 flex items-center">
