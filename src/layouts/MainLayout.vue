        ...
        <div class="flex items-center justify-between q-mb-lg">
          ...
          <div class="q-gutter-sm">
            ...
            <q-btn round unelevated color="grey-3" text-color="dark"  >
              ...
              <q-badge rounded  color="negative" floating label="2"/>
              <q-menu  :offset="[0, 10]" >
                <q-list  style="min-width: 300px">
                  <q-item clickable >
                    <q-item-section side>31.05</q-item-section>
                    <q-item-section>Lorem ipsum dolor.</q-item-section>
                  </q-item>
                  <q-item clickable >
                    <q-item-section side>26.05</q-item-section>
                    <q-item-section>Lorem ipsum dolor sit.</q-item-section>
                  </q-item>
                </q-list>
              </q-menu>
...
const menu_links = ref([
  ...
  {tab_name:'clients',name:'Заказчики',url:'clients',is_enabled:false},
  {tab_name:'admin',name:'Админ',url:'admin',is_enabled:false},
